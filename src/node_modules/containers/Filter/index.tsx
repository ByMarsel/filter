...
const memoizedСolor = uniqByMemorized();
const memoizedKind = uniqByMemorized(); 

const mapStateToProps = (state: AppState) => ({
  ...state.filter,
  colors: memoizedСolor(state.catalog.items, "color").map(
    (x: Pony): SelectedValue => ({ id: x.id, value: x.color, label: x.color })
  ),
  kinds: memoizedKind(state.catalog.items, "kind").map(
